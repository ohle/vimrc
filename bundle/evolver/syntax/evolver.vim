...
" Maintainer:	muwn <muwn.gu@gmail.com>
"		Original author: muwn 
...
syn keyword suevConditional		else elseif end if otherwise
...
syn region suevcomment			start="/\*" end="\*/"	


syn keyword suevIdentifier	color fixed constraints volume density  pressure  no_refine
syn keyword suevOperator	read vertices edges faces bodies	

syn keyword suevFunction	parameter tension gravity constraint boundary optimizing_parameter gravity_constant quantity 
